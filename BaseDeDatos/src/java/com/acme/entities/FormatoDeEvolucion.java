...
@NamedQueries({
    ...
    @NamedQuery(name = "FormatoDeEvolucion.findByFormatodeevolucioncol", query = "SELECT f FROM FormatoDeEvolucion f WHERE f.formatodeevolucioncol = :formatodeevolucioncol")})
public class FormatoDeEvolucion implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 45)
    @Column(name = "Formato de evolucioncol")
    private String formatodeevolucioncol;
    ...
    public FormatoDeEvolucion(Integer idFormatodeevolucion, Date fecha, Date hora, String localizacion, int codcita, String formatodeevolucioncol) {
        this.idFormatodeevolucion = idFormatodeevolucion;
        this.fecha = fecha;
        this.hora = hora;
        this.localizacion = localizacion;
        this.codcita = codcita;
        this.formatodeevolucioncol = formatodeevolucioncol;
    }
    ...
    public String getFormatodeevolucioncol() {
        return formatodeevolucioncol;
    }

    public void setFormatodeevolucioncol(String formatodeevolucioncol) {
        this.formatodeevolucioncol = formatodeevolucioncol;
    }
