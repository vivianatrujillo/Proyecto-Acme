...
public class TratamientoJpaController implements Serializable {
    ...
    public void create(Tratamiento tratamiento) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            utx.begin();
            em = getEntityManager();
            HistoriaClinica idHistoriaClinica = tratamiento.getIdHistoriaClinica();
            if (idHistoriaClinica != null) {
                ...
                tratamiento.setIdHistoriaClinica(idHistoriaClinica);
            }
            ...
            if (idHistoriaClinica != null) {
                idHistoriaClinica.getTratamientoList().add(tratamiento);
    ...
    public void edit(Tratamiento tratamiento) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            HistoriaClinica idHistoriaClinicaOld = persistentTratamiento.getIdHistoriaClinica();
            HistoriaClinica idHistoriaClinicaNew = tratamiento.getIdHistoriaClinica();
            ...
            if (idHistoriaClinicaNew != null) {
                ...
                tratamiento.setIdHistoriaClinica(idHistoriaClinicaNew);
            }
            ...
            if (idHistoriaClinicaOld != null && !idHistoriaClinicaOld.equals(idHistoriaClinicaNew)) {
                idHistoriaClinicaOld.getTratamientoList().remove(tratamiento);
            ...
            if (idHistoriaClinicaNew != null && !idHistoriaClinicaNew.equals(idHistoriaClinicaOld)) {
                idHistoriaClinicaNew.getTratamientoList().add(tratamiento);
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            HistoriaClinica idHistoriaClinica = tratamiento.getIdHistoriaClinica();
            if (idHistoriaClinica != null) {
                idHistoriaClinica.getTratamientoList().remove(tratamiento);
                idHistoriaClinica = em.merge(idHistoriaClinica);
            }
