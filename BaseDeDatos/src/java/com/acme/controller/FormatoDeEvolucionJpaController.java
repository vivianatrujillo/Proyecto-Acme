...
public class FormatoDeEvolucionJpaController implements Serializable {
    ...
    public void create(FormatoDeEvolucion formatoDeEvolucion) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            HistoriaClinica idHistoriaClinica = formatoDeEvolucion.getIdHistoriaClinica();
            if (idHistoriaClinica != null) {
                ...
                formatoDeEvolucion.setIdHistoriaClinica(idHistoriaClinica);
            }
            ...
            if (idHistoriaClinica != null) {
                idHistoriaClinica.getFormatoDeEvolucionList().add(formatoDeEvolucion);
    ...
    public void edit(FormatoDeEvolucion formatoDeEvolucion) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            HistoriaClinica idHistoriaClinicaOld = persistentFormatoDeEvolucion.getIdHistoriaClinica();
            HistoriaClinica idHistoriaClinicaNew = formatoDeEvolucion.getIdHistoriaClinica();
            ...
            if (idHistoriaClinicaNew != null) {
                ...
                formatoDeEvolucion.setIdHistoriaClinica(idHistoriaClinicaNew);
            }
            ...
            if (idHistoriaClinicaOld != null && !idHistoriaClinicaOld.equals(idHistoriaClinicaNew)) {
                idHistoriaClinicaOld.getFormatoDeEvolucionList().remove(formatoDeEvolucion);
            ...
            if (idHistoriaClinicaNew != null && !idHistoriaClinicaNew.equals(idHistoriaClinicaOld)) {
                idHistoriaClinicaNew.getFormatoDeEvolucionList().add(formatoDeEvolucion);
    ...
    public void destroy(Integer id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            HistoriaClinica idHistoriaClinica = formatoDeEvolucion.getIdHistoriaClinica();
            if (idHistoriaClinica != null) {
                idHistoriaClinica.getFormatoDeEvolucionList().remove(formatoDeEvolucion);
                idHistoriaClinica = em.merge(idHistoriaClinica);
            }
